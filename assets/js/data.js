...
const LANDSCAPES = [
  ...
  { id: "mullai", tamil: "முல்லை", roman: "Mullai", en: "Forests & Woodlands", flower: "Jasmine",
    akam: "Patient waiting, domestic faith", akamTamil: "இருத்தல் · Iruttal", puram: "Karanthai — retrieving the herds",
    karu: "Deer, jasmine, millet; herders (āyar/idaiyar); the god Māyōn (Viṣṇu).",
    meaning: "The forest of the faithful heart that waits through the monsoon for a loved one's return. Publicly, the defence of what belongs to the community.",
